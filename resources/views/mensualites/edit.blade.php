        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 row">
                ...
                <div class="form-group col-xs-6 col-sm-6 col-md-6">
                    ...
                    <input type="number" id="net_a_payer" name="net_a_payer" value="{{$mensualite->net_a_payer }}" class="form-control @error('net_a_payer') is-invalid @enderror" placeholder="Montant net a payer...">
                      <div class="invalid-feedback">
                ...
                <div class="form-group col-xs-6 col-sm-6 col-md-6">
                    ...
                    <input type="number" id="montant_verser" name="montant_verser" value="{{$mensualite->montant_verser}}"  class="form-control @error('montant_verser') is-invalid @enderror" placeholder="Montant Verser...">
                      <div class="invalid-feedback">
                ...
                <div class="form-group col-xs-6 col-sm-6 col-md-6">
                    ...
                    <input type="number" id="montant_restant" name="montant_restant" value="{{ $mensualite->montant_restant}}" autocomplete="off" class="form-control @error('montant_restant') is-invalid @enderror" placeholder="Montant Restant...">
                      <div class="invalid-feedback">
                ...
                <div class="form-group col-xs-6 col-sm-6 col-md-6">
                    ...
                    <select name="niveau" id="juzz" class="custom-select form-control  @error('niveau') is-invalid @enderror">
                     ...
                     @foreach ($niveaux as $niveau)
                      <option value="{{$niveau->id}}" {{ old('niveau') == ($mensualite->niveau) ? 'selected' : '' }}>{{$niveau->juzz}}</option> 
                     @endforeach
                    </select>
                    <div class="invalid-feedback">
